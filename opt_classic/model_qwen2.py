...
# [TODO] past_key_values here must be of type Cache and not Tuple(Tensor)!!!
...
class SPModel(nn.Module):
    ...
    def from_pretrained(
        ...
        draft_model = KVQwen2ForCausalLM.from_pretrained(
    ...
    def draft(self,input_ids,nodes,threshold,max_depth,print_time=False):
        ...
        if hasattr(self, "draft_stable_kv") and self.draft_stable_kv is not None:
            kv_len = self.draft_stable_kv.get_seq_length() # [MODIFIED]
        ...
        init_len = past_key_values.get_seq_length() # [MODIFIED]
    ...
    def spgenerate(
        ...
        if hasattr(self, "past_key_values"):
            ...
            (
                ...
                current_length_data,
            ) = initialize_past_key_values(self.base_model) #[TODO]keep an eye on this function, it may cause errors
        ...
        for idx in range(max_length):
            ...
            assert past_key_values.get_seq_length()==draft_position_ids[0] # [MODIFIED]
            ...
            input_ids,best_candidate,accept_length,draft_input_ids,draft_position_ids,tree_attention_mask,parent=verify(input_ids,  #[TODO]keep an eye on this function, it may cause errors
                                                                      logits,
                                                                      draft_input_ids,
                                                                      draft_position_ids,
                                                                      tree_attention_mask,
